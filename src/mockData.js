...
export const chefInitialDishes = [
  ...
  { id: 'DSH-04', name: 'Salad bơ hạt diêm mạch', price: '350,000đ', category: 'Món chính', description: 'Bơ sáp lát mỏng trộn hạt diêm mạch (quinoa), cà chua bi và nước sốt chaim leo chua thanh.', ingredients: 'Bơ sáp (0.5 quả), Hạt diêm mạch (30g), Cà chua bi (50g), Chanh leo', allergens: [], isTodayMenu: true, period: 'Lunch', soldOut: false, enabled: true },
...
export const roomsPageCategories = ['Tất cả', 'Phòng Đôi/Bungalow', 'Phòng Gia Đình/Villa', 'Phòng Cộng Đồng/Tập Thể'];
...
export const blogCategoriesList = ['Tất cả', 'Yoga & Thiền', 'Ẩm Thực', 'Spa Trị Liệu', 'Vật Lý Trị Liệu', 'Lối sống xanh'];
